"""
Example Scripts for Aircraft Design Exploration

This module provides comprehensive examples demonstrating the capabilities
of the aircraft design and analysis system.
"""

import numpy as np
import matplotlib.pyplot as plt
from aircraft import Aircraft, create_sample_aircraft
from flight_conditions import create_test_conditions, FlightEnvelope
from performance_analysis import PerformanceAnalyzer
from design_optimizer import (DesignOptimizer, MaximizeRange, MinimizeFuelConsumption, 
                             MaximizeLiftToDrag, StallSpeedConstraint, TakeoffDistanceConstraint)
...
def example_flight_envelope_analysis():
    ...
    plt.tight_layout()
    plt.savefig('flight_envelope_analysis.png', dpi=300, bbox_inches='tight')
    plt.close()
